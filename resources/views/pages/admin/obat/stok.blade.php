            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="basic-form">
                        <form action="{{ route($prefix.'.medicine.tambah-stok') }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label>Nama Obat</label>
                                <input type="text" id="namaobat" class="form-control" placeholder="Nama Obat" disabled>
                                <input type="hidden" id="idobat" class="form-control" placeholder="Nama Obat" name="id"
                                    required>
                            </div>

                            <div class="form-group">
                                <label>Stok Obat</label>
                                <input type="number" class="form-control" placeholder="Stok Obat" name="stok" required>
                            </div>
